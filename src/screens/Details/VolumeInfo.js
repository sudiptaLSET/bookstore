...
const VolumeInfo = ({ book }) => {
  ...
  return (
    ...
    <Tabs.ScrollView style={styles.container}>
        ...
        <View style={[styles.detailText, { flex: 1 }]}>
          ...
          {book?.volumeInfo?.description?.length > 100 && (
            <TouchableOpacity onPress={() => setFulldesc(!fullDesc)}>
              <Text
                style={{ fontSize: RFValue(12), color: "blue", marginTop: 4 }}
              >
      ...
      <View style={styles.section}>
        <Text style={styles.heading}>Page count :</Text>
      ...
      <View style={styles.section}>
        <Text style={styles.heading}>PrintType :</Text>
      ...
      <View style={styles.section}>
        <Text style={styles.heading}>PreviewLink :</Text>

        <TouchableOpacity
          onPress={() =>
            navigation.navigate("WebScreen", {
              uri: book?.volumeInfo?.previewLink || "",
            })
          }
        >
          <Text
